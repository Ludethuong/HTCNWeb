...
function productHandlerHot(product) {
    if(product.tag=="hot")
    return `
                <a href="product.html" class="product hot" id=${product.id} onclick="transmittion(this)">
                    <div class="image">
                        <img src="${product.image}" alt="">
                    </div>
...
let listProductsHot = products.map((product) => (product.id < 21 ? productHandlerHot(product) : ''));
...
function productHandlerSale(product) {
    if(product.tag=="sale")
    return `
                <a href="product.html" class="product sale" id=${product.id} onclick="transmittion(this)">
                    <div class="image">
                        <img src="${product.image}" alt="">
                    </div>
                    <div class="info-product">
...
let listProductsSale = products.map((product) => (product.id < 21 ? productHandlerSale(product) : ''));
...
function productHandlerNew(product) {
    if(product.tag=="new")
    return `
                <a href="product.html" class="product new" id=${product.id} onclick="transmittion(this)">
                    <div class="image">
                        <img src="${product.image}" alt="">
                    </div>
                    <div class="info-product">
...
let listProductsNew = products.map((product) => (product.id < 21 ? productHandlerNew(product) : ''));
